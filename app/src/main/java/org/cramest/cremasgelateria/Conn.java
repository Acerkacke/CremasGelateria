...
public class Conn {
    ...
    private class BackgroundTask extends AsyncTask<Void, Integer, String>
    {
        ...
        private Uri.Builder creaBuilder(String pagina){
            Uri.Builder builder = new Uri.Builder();
            builder.scheme("http").authority("ramproda.altervista.org") //Da modificare nel caso si voglia applicare ad altri siti
                    .appendPath("Android")
                    .appendPath("Cremas")
                    .appendPath(pagina+".php");
            if(nomiParametro != null && valoriParametro != null && nomiParametro[0] != null && valoriParametro[0] != null) { //Se richiede qualcosa
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try {
                URL url = null;
                Uri.Builder builder = creaBuilder(pagina);
